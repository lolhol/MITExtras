...
public class MacroUtil {
    ...
    public static void snapTo(final Vec3 target) {
        ...
        thePlayer.rotationYaw += (float)MathHelper.wrapAngleTo180_double(MathHelper.atan2(diffZ, diffX) * 57.29577951308232 - 90 - mc.thePlayer.rotationYaw);
        final EntityPlayerSP thePlayer2 = mc.thePlayer;
        thePlayer2.rotationPitch += (float)MathHelper.wrapAngleTo180_double(-(MathHelper.atan2(diffY, (double)MathHelper.sqrt_double(diffX * diffX + diffZ * diffZ)) * 57.29577951308232) - mc.thePlayer.rotationPitch);
    }
}
